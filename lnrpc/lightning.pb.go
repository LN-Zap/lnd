...
var file_lightning_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x69, 0x6e, 0x74, 0x73, 0x22, 0x2b, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x54, 0x72, 0x61,
	...
	0x78, 0x69, 0x64, 0x22, 0x90, 0x01, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73,
	...
	0x65, 0x76, 0x61, 0x6e, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x69,
	0x6e, 0x64, 0x65, 0x78, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x62, 0x6c, 0x6f, 0x63,
	0x6b, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x22, 0x74, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x54, 0x72, 0x61,
	...
	0x45, 0x54, 0x45, 0x52, 0x10, 0x04, 0x32, 0xbf, 0x27, 0x0a, 0x09, 0x4c, 0x69, 0x67, 0x68, 0x74,
	...
	0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1c, 0x2e, 0x6c, 0x6e,
	0x72, 0x70, 0x63, 0x2e, 0x47, 0x65, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1d, 0x2e, 0x6c, 0x6e, 0x72, 0x70,
...
var file_lightning_proto_goTypes = []interface{}{
	...
	(*GetTransactionRequest)(nil),                               // 29: lnrpc.GetTransactionRequest
	(*GetTransactionResponse)(nil),                              // 30: lnrpc.GetTransactionResponse
...
var file_lightning_proto_depIdxs = []int32{
	...
	40,  // 1: lnrpc.Utxo.outpoint:type_name -> lnrpc.OutPoint
	...
	41,  // 4: lnrpc.Transaction.previous_outpoints:type_name -> lnrpc.PreviousOutPoint
	28,  // 5: lnrpc.GetTransactionResponse.transaction:type_name -> lnrpc.Transaction
	28,  // 6: lnrpc.TransactionDetails.transactions:type_name -> lnrpc.Transaction
	33,  // 7: lnrpc.SendRequest.fee_limit:type_name -> lnrpc.FeeLimit
	...
	124, // 10: lnrpc.SendResponse.payment_route:type_name -> lnrpc.Route
	124, // 11: lnrpc.SendToRouteRequest.route:type_name -> lnrpc.Route
	...
	42,  // 17: lnrpc.ConnectPeerRequest.addr:type_name -> lnrpc.LightningAddress
	61,  // 18: lnrpc.Channel.pending_htlcs:type_name -> lnrpc.HTLC
	2,   // 19: lnrpc.Channel.commitment_type:type_name -> lnrpc.CommitmentType
	62,  // 20: lnrpc.Channel.local_constraints:type_name -> lnrpc.ChannelConstraints
	62,  // 21: lnrpc.Channel.remote_constraints:type_name -> lnrpc.ChannelConstraints
	63,  // 22: lnrpc.ListChannelsResponse.channels:type_name -> lnrpc.Channel
	66,  // 23: lnrpc.ListAliasesResponse.alias_maps:type_name -> lnrpc.AliasMap
	...
	70,  // 27: lnrpc.ChannelCloseSummary.resolutions:type_name -> lnrpc.Resolution
	...
	40,  // 30: lnrpc.Resolution.outpoint:type_name -> lnrpc.OutPoint
	69,  // 31: lnrpc.ClosedChannelsResponse.channels:type_name -> lnrpc.ChannelCloseSummary
	12,  // 32: lnrpc.Peer.sync_type:type_name -> lnrpc.Peer.SyncType
	217, // 33: lnrpc.Peer.features:type_name -> lnrpc.Peer.FeaturesEntry
	74,  // 34: lnrpc.Peer.errors:type_name -> lnrpc.TimestampedError
	73,  // 35: lnrpc.ListPeersResponse.peers:type_name -> lnrpc.Peer
	13,  // 36: lnrpc.PeerEvent.type:type_name -> lnrpc.PeerEvent.EventType
	83,  // 37: lnrpc.GetInfoResponse.chains:type_name -> lnrpc.Chain
	218, // 38: lnrpc.GetInfoResponse.features:type_name -> lnrpc.GetInfoResponse.FeaturesEntry
	39,  // 39: lnrpc.ChannelOpenUpdate.channel_point:type_name -> lnrpc.ChannelPoint
	39,  // 40: lnrpc.CloseChannelRequest.channel_point:type_name -> lnrpc.ChannelPoint
	...
	40,  // 48: lnrpc.OpenChannelRequest.outpoints:type_name -> lnrpc.OutPoint
	...
	39,  // 53: lnrpc.ChanPointShim.chan_point:type_name -> lnrpc.ChannelPoint
	...
	220, // 61: lnrpc.PendingChannelsResponse.pending_open_channels:type_name -> lnrpc.PendingChannelsResponse.PendingOpenChannel
	223, // 62: lnrpc.PendingChannelsResponse.pending_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ClosedChannel
	224, // 63: lnrpc.PendingChannelsResponse.pending_force_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ForceClosedChannel
	221, // 64: lnrpc.PendingChannelsResponse.waiting_close_channels:type_name -> lnrpc.PendingChannelsResponse.WaitingCloseChannel
	63,  // 65: lnrpc.ChannelEventUpdate.open_channel:type_name -> lnrpc.Channel
	69,  // 66: lnrpc.ChannelEventUpdate.closed_channel:type_name -> lnrpc.ChannelCloseSummary
	39,  // 67: lnrpc.ChannelEventUpdate.active_channel:type_name -> lnrpc.ChannelPoint
	39,  // 68: lnrpc.ChannelEventUpdate.inactive_channel:type_name -> lnrpc.ChannelPoint
	89,  // 69: lnrpc.ChannelEventUpdate.pending_open_channel:type_name -> lnrpc.PendingUpdate
	39,  // 70: lnrpc.ChannelEventUpdate.fully_resolved_channel:type_name -> lnrpc.ChannelPoint
	15,  // 71: lnrpc.ChannelEventUpdate.type:type_name -> lnrpc.ChannelEventUpdate.UpdateType
	225, // 72: lnrpc.WalletBalanceResponse.account_balance:type_name -> lnrpc.WalletBalanceResponse.AccountBalanceEntry
	...
	33,  // 79: lnrpc.QueryRoutesRequest.fee_limit:type_name -> lnrpc.FeeLimit
	...
	226, // 82: lnrpc.QueryRoutesRequest.dest_custom_records:type_name -> lnrpc.QueryRoutesRequest.DestCustomRecordsEntry
	...
	124, // 85: lnrpc.QueryRoutesResponse.routes:type_name -> lnrpc.Route
	122, // 86: lnrpc.Hop.mpp_record:type_name -> lnrpc.MPPRecord
	123, // 87: lnrpc.Hop.amp_record:type_name -> lnrpc.AMPRecord
	227, // 88: lnrpc.Hop.custom_records:type_name -> lnrpc.Hop.CustomRecordsEntry
	121, // 89: lnrpc.Route.hops:type_name -> lnrpc.Hop
	127, // 90: lnrpc.NodeInfo.node:type_name -> lnrpc.LightningNode
	130, // 91: lnrpc.NodeInfo.channels:type_name -> lnrpc.ChannelEdge
	128, // 92: lnrpc.LightningNode.addresses:type_name -> lnrpc.NodeAddress
	228, // 93: lnrpc.LightningNode.features:type_name -> lnrpc.LightningNode.FeaturesEntry
	229, // 94: lnrpc.LightningNode.custom_records:type_name -> lnrpc.LightningNode.CustomRecordsEntry
	230, // 95: lnrpc.RoutingPolicy.custom_records:type_name -> lnrpc.RoutingPolicy.CustomRecordsEntry
	129, // 96: lnrpc.ChannelEdge.node1_policy:type_name -> lnrpc.RoutingPolicy
	129, // 97: lnrpc.ChannelEdge.node2_policy:type_name -> lnrpc.RoutingPolicy
	231, // 98: lnrpc.ChannelEdge.custom_records:type_name -> lnrpc.ChannelEdge.CustomRecordsEntry
	127, // 99: lnrpc.ChannelGraph.nodes:type_name -> lnrpc.LightningNode
	130, // 100: lnrpc.ChannelGraph.edges:type_name -> lnrpc.ChannelEdge
	6,   // 101: lnrpc.NodeMetricsRequest.types:type_name -> lnrpc.NodeMetricType
	232, // 102: lnrpc.NodeMetricsResponse.betweenness_centrality:type_name -> lnrpc.NodeMetricsResponse.BetweennessCentralityEntry
	143, // 103: lnrpc.GraphTopologyUpdate.node_updates:type_name -> lnrpc.NodeUpdate
	144, // 104: lnrpc.GraphTopologyUpdate.channel_updates:type_name -> lnrpc.ChannelEdgeUpdate
	145, // 105: lnrpc.GraphTopologyUpdate.closed_chans:type_name -> lnrpc.ClosedChannelUpdate
	128, // 106: lnrpc.NodeUpdate.node_addresses:type_name -> lnrpc.NodeAddress
	233, // 107: lnrpc.NodeUpdate.features:type_name -> lnrpc.NodeUpdate.FeaturesEntry
	39,  // 108: lnrpc.ChannelEdgeUpdate.chan_point:type_name -> lnrpc.ChannelPoint
	129, // 109: lnrpc.ChannelEdgeUpdate.routing_policy:type_name -> lnrpc.RoutingPolicy
	39,  // 110: lnrpc.ClosedChannelUpdate.chan_point:type_name -> lnrpc.ChannelPoint
	146, // 111: lnrpc.RouteHint.hop_hints:type_name -> lnrpc.HopHint
	7,   // 112: lnrpc.AMPInvoiceState.state:type_name -> lnrpc.InvoiceHTLCState
	148, // 113: lnrpc.Invoice.route_hints:type_name -> lnrpc.RouteHint
	16,  // 114: lnrpc.Invoice.state:type_name -> lnrpc.Invoice.InvoiceState
	151, // 115: lnrpc.Invoice.htlcs:type_name -> lnrpc.InvoiceHTLC
	234, // 116: lnrpc.Invoice.features:type_name -> lnrpc.Invoice.FeaturesEntry
	235, // 117: lnrpc.Invoice.amp_invoice_state:type_name -> lnrpc.Invoice.AmpInvoiceStateEntry
	7,   // 118: lnrpc.InvoiceHTLC.state:type_name -> lnrpc.InvoiceHTLCState
	236, // 119: lnrpc.InvoiceHTLC.custom_records:type_name -> lnrpc.InvoiceHTLC.CustomRecordsEntry
	152, // 120: lnrpc.InvoiceHTLC.amp:type_name -> lnrpc.AMP
	150, // 121: lnrpc.ListInvoiceResponse.invoices:type_name -> lnrpc.Invoice
	17,  // 122: lnrpc.Payment.status:type_name -> lnrpc.Payment.PaymentStatus
	159, // 123: lnrpc.Payment.htlcs:type_name -> lnrpc.HTLCAttempt
	...
	124, // 126: lnrpc.HTLCAttempt.route:type_name -> lnrpc.Route
	202, // 127: lnrpc.HTLCAttempt.failure:type_name -> lnrpc.Failure
	158, // 128: lnrpc.ListPaymentsResponse.payments:type_name -> lnrpc.Payment
	39,  // 129: lnrpc.AbandonChannelRequest.channel_point:type_name -> lnrpc.ChannelPoint
	148, // 130: lnrpc.PayReq.route_hints:type_name -> lnrpc.RouteHint
	237, // 131: lnrpc.PayReq.features:type_name -> lnrpc.PayReq.FeaturesEntry
	174, // 132: lnrpc.FeeReportResponse.channel_fees:type_name -> lnrpc.ChannelFeeReport
	39,  // 133: lnrpc.PolicyUpdateRequest.chan_point:type_name -> lnrpc.ChannelPoint
	40,  // 134: lnrpc.FailedUpdate.outpoint:type_name -> lnrpc.OutPoint
	10,  // 135: lnrpc.FailedUpdate.reason:type_name -> lnrpc.UpdateFailure
	177, // 136: lnrpc.PolicyUpdateResponse.failed_updates:type_name -> lnrpc.FailedUpdate
	180, // 137: lnrpc.ForwardingHistoryResponse.forwarding_events:type_name -> lnrpc.ForwardingEvent
	39,  // 138: lnrpc.ExportChannelBackupRequest.chan_point:type_name -> lnrpc.ChannelPoint
	39,  // 139: lnrpc.ChannelBackup.chan_point:type_name -> lnrpc.ChannelPoint
	39,  // 140: lnrpc.MultiChanBackup.chan_points:type_name -> lnrpc.ChannelPoint
	187, // 141: lnrpc.ChanBackupSnapshot.single_chan_backups:type_name -> lnrpc.ChannelBackups
	184, // 142: lnrpc.ChanBackupSnapshot.multi_chan_backup:type_name -> lnrpc.MultiChanBackup
	183, // 143: lnrpc.ChannelBackups.chan_backups:type_name -> lnrpc.ChannelBackup
	187, // 144: lnrpc.RestoreChanBackupRequest.chan_backups:type_name -> lnrpc.ChannelBackups
	192, // 145: lnrpc.BakeMacaroonRequest.permissions:type_name -> lnrpc.MacaroonPermission
	192, // 146: lnrpc.MacaroonPermissionList.permissions:type_name -> lnrpc.MacaroonPermission
	238, // 147: lnrpc.ListPermissionsResponse.method_permissions:type_name -> lnrpc.ListPermissionsResponse.MethodPermissionsEntry
	19,  // 148: lnrpc.Failure.code:type_name -> lnrpc.Failure.FailureCode
	203, // 149: lnrpc.Failure.channel_update:type_name -> lnrpc.ChannelUpdate
	205, // 150: lnrpc.MacaroonId.ops:type_name -> lnrpc.Op
	192, // 151: lnrpc.CheckMacPermRequest.permissions:type_name -> lnrpc.MacaroonPermission
	209, // 152: lnrpc.RPCMiddlewareRequest.stream_auth:type_name -> lnrpc.StreamAuth
	210, // 153: lnrpc.RPCMiddlewareRequest.request:type_name -> lnrpc.RPCMessage
	210, // 154: lnrpc.RPCMiddlewareRequest.response:type_name -> lnrpc.RPCMessage
	212, // 155: lnrpc.RPCMiddlewareResponse.register:type_name -> lnrpc.MiddlewareRegistration
	213, // 156: lnrpc.RPCMiddlewareResponse.feedback:type_name -> lnrpc.InterceptFeedback
	172, // 157: lnrpc.Peer.FeaturesEntry.value:type_name -> lnrpc.Feature
	172, // 158: lnrpc.GetInfoResponse.FeaturesEntry.value:type_name -> lnrpc.Feature
	...
	219, // 161: lnrpc.PendingChannelsResponse.PendingOpenChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	219, // 162: lnrpc.PendingChannelsResponse.WaitingCloseChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	222, // 163: lnrpc.PendingChannelsResponse.WaitingCloseChannel.commitments:type_name -> lnrpc.PendingChannelsResponse.Commitments
	219, // 164: lnrpc.PendingChannelsResponse.ClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	219, // 165: lnrpc.PendingChannelsResponse.ForceClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	106, // 166: lnrpc.PendingChannelsResponse.ForceClosedChannel.pending_htlcs:type_name -> lnrpc.PendingHTLC
	...
	111, // 168: lnrpc.WalletBalanceResponse.AccountBalanceEntry.value:type_name -> lnrpc.WalletAccountBalance
	172, // 169: lnrpc.LightningNode.FeaturesEntry.value:type_name -> lnrpc.Feature
	135, // 170: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry.value:type_name -> lnrpc.FloatMetric
	172, // 171: lnrpc.NodeUpdate.FeaturesEntry.value:type_name -> lnrpc.Feature
	172, // 172: lnrpc.Invoice.FeaturesEntry.value:type_name -> lnrpc.Feature
	149, // 173: lnrpc.Invoice.AmpInvoiceStateEntry.value:type_name -> lnrpc.AMPInvoiceState
	172, // 174: lnrpc.PayReq.FeaturesEntry.value:type_name -> lnrpc.Feature
	199, // 175: lnrpc.ListPermissionsResponse.MethodPermissionsEntry.value:type_name -> lnrpc.MacaroonPermissionList
	112, // 176: lnrpc.Lightning.WalletBalance:input_type -> lnrpc.WalletBalanceRequest
	115, // 177: lnrpc.Lightning.ChannelBalance:input_type -> lnrpc.ChannelBalanceRequest
	31,  // 178: lnrpc.Lightning.GetTransactions:input_type -> lnrpc.GetTransactionsRequest
	43,  // 179: lnrpc.Lightning.EstimateFee:input_type -> lnrpc.EstimateFeeRequest
	47,  // 180: lnrpc.Lightning.SendCoins:input_type -> lnrpc.SendCoinsRequest
	49,  // 181: lnrpc.Lightning.ListUnspent:input_type -> lnrpc.ListUnspentRequest
	31,  // 182: lnrpc.Lightning.SubscribeTransactions:input_type -> lnrpc.GetTransactionsRequest
	45,  // 183: lnrpc.Lightning.SendMany:input_type -> lnrpc.SendManyRequest
	51,  // 184: lnrpc.Lightning.NewAddress:input_type -> lnrpc.NewAddressRequest
	53,  // 185: lnrpc.Lightning.SignMessage:input_type -> lnrpc.SignMessageRequest
	55,  // 186: lnrpc.Lightning.VerifyMessage:input_type -> lnrpc.VerifyMessageRequest
	57,  // 187: lnrpc.Lightning.ConnectPeer:input_type -> lnrpc.ConnectPeerRequest
	59,  // 188: lnrpc.Lightning.DisconnectPeer:input_type -> lnrpc.DisconnectPeerRequest
	75,  // 189: lnrpc.Lightning.ListPeers:input_type -> lnrpc.ListPeersRequest
	77,  // 190: lnrpc.Lightning.SubscribePeerEvents:input_type -> lnrpc.PeerEventSubscription
	79,  // 191: lnrpc.Lightning.GetInfo:input_type -> lnrpc.GetInfoRequest
	81,  // 192: lnrpc.Lightning.GetRecoveryInfo:input_type -> lnrpc.GetRecoveryInfoRequest
	107, // 193: lnrpc.Lightning.PendingChannels:input_type -> lnrpc.PendingChannelsRequest
	64,  // 194: lnrpc.Lightning.ListChannels:input_type -> lnrpc.ListChannelsRequest
	109, // 195: lnrpc.Lightning.SubscribeChannelEvents:input_type -> lnrpc.ChannelEventSubscription
	71,  // 196: lnrpc.Lightning.ClosedChannels:input_type -> lnrpc.ClosedChannelsRequest
	94,  // 197: lnrpc.Lightning.OpenChannelSync:input_type -> lnrpc.OpenChannelRequest
	94,  // 198: lnrpc.Lightning.OpenChannel:input_type -> lnrpc.OpenChannelRequest
	91,  // 199: lnrpc.Lightning.BatchOpenChannel:input_type -> lnrpc.BatchOpenChannelRequest
	104, // 200: lnrpc.Lightning.FundingStateStep:input_type -> lnrpc.FundingTransitionMsg
	38,  // 201: lnrpc.Lightning.ChannelAcceptor:input_type -> lnrpc.ChannelAcceptResponse
	87,  // 202: lnrpc.Lightning.CloseChannel:input_type -> lnrpc.CloseChannelRequest
	166, // 203: lnrpc.Lightning.AbandonChannel:input_type -> lnrpc.AbandonChannelRequest
	34,  // 204: lnrpc.Lightning.SendPayment:input_type -> lnrpc.SendRequest
	34,  // 205: lnrpc.Lightning.SendPaymentSync:input_type -> lnrpc.SendRequest
	36,  // 206: lnrpc.Lightning.SendToRoute:input_type -> lnrpc.SendToRouteRequest
	36,  // 207: lnrpc.Lightning.SendToRouteSync:input_type -> lnrpc.SendToRouteRequest
	150, // 208: lnrpc.Lightning.AddInvoice:input_type -> lnrpc.Invoice
	155, // 209: lnrpc.Lightning.ListInvoices:input_type -> lnrpc.ListInvoiceRequest
	154, // 210: lnrpc.Lightning.LookupInvoice:input_type -> lnrpc.PaymentHash
	157, // 211: lnrpc.Lightning.SubscribeInvoices:input_type -> lnrpc.InvoiceSubscription
	170, // 212: lnrpc.Lightning.DecodePayReq:input_type -> lnrpc.PayReqString
	160, // 213: lnrpc.Lightning.ListPayments:input_type -> lnrpc.ListPaymentsRequest
	162, // 214: lnrpc.Lightning.DeletePayment:input_type -> lnrpc.DeletePaymentRequest
	163, // 215: lnrpc.Lightning.DeleteAllPayments:input_type -> lnrpc.DeleteAllPaymentsRequest
	131, // 216: lnrpc.Lightning.DescribeGraph:input_type -> lnrpc.ChannelGraphRequest
	133, // 217: lnrpc.Lightning.GetNodeMetrics:input_type -> lnrpc.NodeMetricsRequest
	136, // 218: lnrpc.Lightning.GetChanInfo:input_type -> lnrpc.ChanInfoRequest
	125, // 219: lnrpc.Lightning.GetNodeInfo:input_type -> lnrpc.NodeInfoRequest
	117, // 220: lnrpc.Lightning.QueryRoutes:input_type -> lnrpc.QueryRoutesRequest
	137, // 221: lnrpc.Lightning.GetNetworkInfo:input_type -> lnrpc.NetworkInfoRequest
	139, // 222: lnrpc.Lightning.StopDaemon:input_type -> lnrpc.StopRequest
	141, // 223: lnrpc.Lightning.SubscribeChannelGraph:input_type -> lnrpc.GraphTopologySubscription
	168, // 224: lnrpc.Lightning.DebugLevel:input_type -> lnrpc.DebugLevelRequest
	173, // 225: lnrpc.Lightning.FeeReport:input_type -> lnrpc.FeeReportRequest
	176, // 226: lnrpc.Lightning.UpdateChannelPolicy:input_type -> lnrpc.PolicyUpdateRequest
	179, // 227: lnrpc.Lightning.ForwardingHistory:input_type -> lnrpc.ForwardingHistoryRequest
	182, // 228: lnrpc.Lightning.ExportChannelBackup:input_type -> lnrpc.ExportChannelBackupRequest
	185, // 229: lnrpc.Lightning.ExportAllChannelBackups:input_type -> lnrpc.ChanBackupExportRequest
	186, // 230: lnrpc.Lightning.VerifyChanBackup:input_type -> lnrpc.ChanBackupSnapshot
	188, // 231: lnrpc.Lightning.RestoreChannelBackups:input_type -> lnrpc.RestoreChanBackupRequest
	190, // 232: lnrpc.Lightning.SubscribeChannelBackups:input_type -> lnrpc.ChannelBackupSubscription
	193, // 233: lnrpc.Lightning.BakeMacaroon:input_type -> lnrpc.BakeMacaroonRequest
	195, // 234: lnrpc.Lightning.ListMacaroonIDs:input_type -> lnrpc.ListMacaroonIDsRequest
	197, // 235: lnrpc.Lightning.DeleteMacaroonID:input_type -> lnrpc.DeleteMacaroonIDRequest
	200, // 236: lnrpc.Lightning.ListPermissions:input_type -> lnrpc.ListPermissionsRequest
	206, // 237: lnrpc.Lightning.CheckMacaroonPermissions:input_type -> lnrpc.CheckMacPermRequest
	211, // 238: lnrpc.Lightning.RegisterRPCMiddleware:input_type -> lnrpc.RPCMiddlewareResponse
	...
	67,  // 241: lnrpc.Lightning.ListAliases:input_type -> lnrpc.ListAliasesRequest
	20,  // 242: lnrpc.Lightning.LookupHtlcResolution:input_type -> lnrpc.LookupHtlcResolutionRequest
	29,  // 243: lnrpc.Lightning.GetTransaction:input_type -> lnrpc.GetTransactionRequest
	113, // 244: lnrpc.Lightning.WalletBalance:output_type -> lnrpc.WalletBalanceResponse
	116, // 245: lnrpc.Lightning.ChannelBalance:output_type -> lnrpc.ChannelBalanceResponse
	32,  // 246: lnrpc.Lightning.GetTransactions:output_type -> lnrpc.TransactionDetails
	44,  // 247: lnrpc.Lightning.EstimateFee:output_type -> lnrpc.EstimateFeeResponse
	48,  // 248: lnrpc.Lightning.SendCoins:output_type -> lnrpc.SendCoinsResponse
	50,  // 249: lnrpc.Lightning.ListUnspent:output_type -> lnrpc.ListUnspentResponse
	28,  // 250: lnrpc.Lightning.SubscribeTransactions:output_type -> lnrpc.Transaction
	46,  // 251: lnrpc.Lightning.SendMany:output_type -> lnrpc.SendManyResponse
	52,  // 252: lnrpc.Lightning.NewAddress:output_type -> lnrpc.NewAddressResponse
	54,  // 253: lnrpc.Lightning.SignMessage:output_type -> lnrpc.SignMessageResponse
	56,  // 254: lnrpc.Lightning.VerifyMessage:output_type -> lnrpc.VerifyMessageResponse
	58,  // 255: lnrpc.Lightning.ConnectPeer:output_type -> lnrpc.ConnectPeerResponse
	60,  // 256: lnrpc.Lightning.DisconnectPeer:output_type -> lnrpc.DisconnectPeerResponse
	76,  // 257: lnrpc.Lightning.ListPeers:output_type -> lnrpc.ListPeersResponse
	78,  // 258: lnrpc.Lightning.SubscribePeerEvents:output_type -> lnrpc.PeerEvent
	80,  // 259: lnrpc.Lightning.GetInfo:output_type -> lnrpc.GetInfoResponse
	82,  // 260: lnrpc.Lightning.GetRecoveryInfo:output_type -> lnrpc.GetRecoveryInfoResponse
	108, // 261: lnrpc.Lightning.PendingChannels:output_type -> lnrpc.PendingChannelsResponse
	65,  // 262: lnrpc.Lightning.ListChannels:output_type -> lnrpc.ListChannelsResponse
	110, // 263: lnrpc.Lightning.SubscribeChannelEvents:output_type -> lnrpc.ChannelEventUpdate
	72,  // 264: lnrpc.Lightning.ClosedChannels:output_type -> lnrpc.ClosedChannelsResponse
	39,  // 265: lnrpc.Lightning.OpenChannelSync:output_type -> lnrpc.ChannelPoint
	95,  // 266: lnrpc.Lightning.OpenChannel:output_type -> lnrpc.OpenStatusUpdate
	93,  // 267: lnrpc.Lightning.BatchOpenChannel:output_type -> lnrpc.BatchOpenChannelResponse
	105, // 268: lnrpc.Lightning.FundingStateStep:output_type -> lnrpc.FundingStateStepResp
	37,  // 269: lnrpc.Lightning.ChannelAcceptor:output_type -> lnrpc.ChannelAcceptRequest
	88,  // 270: lnrpc.Lightning.CloseChannel:output_type -> lnrpc.CloseStatusUpdate
	167, // 271: lnrpc.Lightning.AbandonChannel:output_type -> lnrpc.AbandonChannelResponse
	35,  // 272: lnrpc.Lightning.SendPayment:output_type -> lnrpc.SendResponse
	35,  // 273: lnrpc.Lightning.SendPaymentSync:output_type -> lnrpc.SendResponse
	35,  // 274: lnrpc.Lightning.SendToRoute:output_type -> lnrpc.SendResponse
	35,  // 275: lnrpc.Lightning.SendToRouteSync:output_type -> lnrpc.SendResponse
	153, // 276: lnrpc.Lightning.AddInvoice:output_type -> lnrpc.AddInvoiceResponse
	156, // 277: lnrpc.Lightning.ListInvoices:output_type -> lnrpc.ListInvoiceResponse
	150, // 278: lnrpc.Lightning.LookupInvoice:output_type -> lnrpc.Invoice
	150, // 279: lnrpc.Lightning.SubscribeInvoices:output_type -> lnrpc.Invoice
	171, // 280: lnrpc.Lightning.DecodePayReq:output_type -> lnrpc.PayReq
	161, // 281: lnrpc.Lightning.ListPayments:output_type -> lnrpc.ListPaymentsResponse
	164, // 282: lnrpc.Lightning.DeletePayment:output_type -> lnrpc.DeletePaymentResponse
	165, // 283: lnrpc.Lightning.DeleteAllPayments:output_type -> lnrpc.DeleteAllPaymentsResponse
	132, // 284: lnrpc.Lightning.DescribeGraph:output_type -> lnrpc.ChannelGraph
	134, // 285: lnrpc.Lightning.GetNodeMetrics:output_type -> lnrpc.NodeMetricsResponse
	130, // 286: lnrpc.Lightning.GetChanInfo:output_type -> lnrpc.ChannelEdge
	126, // 287: lnrpc.Lightning.GetNodeInfo:output_type -> lnrpc.NodeInfo
	120, // 288: lnrpc.Lightning.QueryRoutes:output_type -> lnrpc.QueryRoutesResponse
	138, // 289: lnrpc.Lightning.GetNetworkInfo:output_type -> lnrpc.NetworkInfo
	140, // 290: lnrpc.Lightning.StopDaemon:output_type -> lnrpc.StopResponse
	142, // 291: lnrpc.Lightning.SubscribeChannelGraph:output_type -> lnrpc.GraphTopologyUpdate
	169, // 292: lnrpc.Lightning.DebugLevel:output_type -> lnrpc.DebugLevelResponse
	175, // 293: lnrpc.Lightning.FeeReport:output_type -> lnrpc.FeeReportResponse
	178, // 294: lnrpc.Lightning.UpdateChannelPolicy:output_type -> lnrpc.PolicyUpdateResponse
	181, // 295: lnrpc.Lightning.ForwardingHistory:output_type -> lnrpc.ForwardingHistoryResponse
	183, // 296: lnrpc.Lightning.ExportChannelBackup:output_type -> lnrpc.ChannelBackup
	186, // 297: lnrpc.Lightning.ExportAllChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	191, // 298: lnrpc.Lightning.VerifyChanBackup:output_type -> lnrpc.VerifyChanBackupResponse
	189, // 299: lnrpc.Lightning.RestoreChannelBackups:output_type -> lnrpc.RestoreBackupResponse
	186, // 300: lnrpc.Lightning.SubscribeChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	194, // 301: lnrpc.Lightning.BakeMacaroon:output_type -> lnrpc.BakeMacaroonResponse
	196, // 302: lnrpc.Lightning.ListMacaroonIDs:output_type -> lnrpc.ListMacaroonIDsResponse
	198, // 303: lnrpc.Lightning.DeleteMacaroonID:output_type -> lnrpc.DeleteMacaroonIDResponse
	201, // 304: lnrpc.Lightning.ListPermissions:output_type -> lnrpc.ListPermissionsResponse
	207, // 305: lnrpc.Lightning.CheckMacaroonPermissions:output_type -> lnrpc.CheckMacPermResponse
	208, // 306: lnrpc.Lightning.RegisterRPCMiddleware:output_type -> lnrpc.RPCMiddlewareRequest
	...
	68,  // 309: lnrpc.Lightning.ListAliases:output_type -> lnrpc.ListAliasesResponse
	21,  // 310: lnrpc.Lightning.LookupHtlcResolution:output_type -> lnrpc.LookupHtlcResolutionResponse
	30,  // 311: lnrpc.Lightning.GetTransaction:output_type -> lnrpc.GetTransactionResponse
