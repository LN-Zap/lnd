...
func (Failure_FailureCode) EnumDescriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{184, 0}
}
...
var file_lightning_proto_rawDesc = []byte{
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x2f, 0x0a, 0x13, 0x49, 0x73, 0x4f,
	0x75, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x12, 0x18, 0x0a, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x2f, 0x0a, 0x14, 0x49, 0x73,
	0x4f, 0x75, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x69, 0x73, 0x5f, 0x6f, 0x75, 0x72, 0x73, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x08, 0x52, 0x06, 0x69, 0x73, 0x4f, 0x75, 0x72, 0x73, 0x22, 0xb0, 0x08, 0x0a, 0x07,
	...
	0x41, 0x4d, 0x45, 0x54, 0x45, 0x52, 0x10, 0x04, 0x32, 0x88, 0x28, 0x0a, 0x09, 0x4c, 0x69, 0x67,
	...
	0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x47, 0x0a, 0x0c, 0x49,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4d, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73,
	0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1c, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x47,
	0x65, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x1d, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x47, 0x65, 0x74,
...
var file_lightning_proto_goTypes = []interface{}{
	...
	(*IsOurAddressRequest)(nil),                                 // 202: lnrpc.IsOurAddressRequest
	(*IsOurAddressResponse)(nil),                                // 203: lnrpc.IsOurAddressResponse
	(*Failure)(nil),                                             // 204: lnrpc.Failure
...
var file_lightning_proto_depIdxs = []int32{
	...
	216, // 8: lnrpc.SendRequest.dest_custom_records:type_name -> lnrpc.SendRequest.DestCustomRecordsEntry
	...
	217, // 13: lnrpc.EstimateFeeRequest.AddrToAmount:type_name -> lnrpc.EstimateFeeRequest.AddrToAmountEntry
	218, // 14: lnrpc.SendManyRequest.AddrToAmount:type_name -> lnrpc.SendManyRequest.AddrToAmountEntry
	...
	219, // 33: lnrpc.Peer.features:type_name -> lnrpc.Peer.FeaturesEntry
	...
	220, // 38: lnrpc.GetInfoResponse.features:type_name -> lnrpc.GetInfoResponse.FeaturesEntry
	...
	222, // 61: lnrpc.PendingChannelsResponse.pending_open_channels:type_name -> lnrpc.PendingChannelsResponse.PendingOpenChannel
	225, // 62: lnrpc.PendingChannelsResponse.pending_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ClosedChannel
	226, // 63: lnrpc.PendingChannelsResponse.pending_force_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ForceClosedChannel
	223, // 64: lnrpc.PendingChannelsResponse.waiting_close_channels:type_name -> lnrpc.PendingChannelsResponse.WaitingCloseChannel
	...
	227, // 72: lnrpc.WalletBalanceResponse.account_balance:type_name -> lnrpc.WalletBalanceResponse.AccountBalanceEntry
	...
	228, // 82: lnrpc.QueryRoutesRequest.dest_custom_records:type_name -> lnrpc.QueryRoutesRequest.DestCustomRecordsEntry
	...
	236, // 116: lnrpc.Invoice.features:type_name -> lnrpc.Invoice.FeaturesEntry
	237, // 117: lnrpc.Invoice.amp_invoice_state:type_name -> lnrpc.Invoice.AmpInvoiceStateEntry
	7,   // 118: lnrpc.InvoiceHTLC.state:type_name -> lnrpc.InvoiceHTLCState
	238, // 119: lnrpc.InvoiceHTLC.custom_records:type_name -> lnrpc.InvoiceHTLC.CustomRecordsEntry
	...
	204, // 127: lnrpc.HTLCAttempt.failure:type_name -> lnrpc.Failure
	...
	239, // 131: lnrpc.PayReq.features:type_name -> lnrpc.PayReq.FeaturesEntry
	...
	240, // 147: lnrpc.ListPermissionsResponse.method_permissions:type_name -> lnrpc.ListPermissionsResponse.MethodPermissionsEntry
	19,  // 148: lnrpc.Failure.code:type_name -> lnrpc.Failure.FailureCode
	205, // 149: lnrpc.Failure.channel_update:type_name -> lnrpc.ChannelUpdate
	207, // 150: lnrpc.MacaroonId.ops:type_name -> lnrpc.Op
	192, // 151: lnrpc.CheckMacPermRequest.permissions:type_name -> lnrpc.MacaroonPermission
	211, // 152: lnrpc.RPCMiddlewareRequest.stream_auth:type_name -> lnrpc.StreamAuth
	212, // 153: lnrpc.RPCMiddlewareRequest.request:type_name -> lnrpc.RPCMessage
	212, // 154: lnrpc.RPCMiddlewareRequest.response:type_name -> lnrpc.RPCMessage
	214, // 155: lnrpc.RPCMiddlewareResponse.register:type_name -> lnrpc.MiddlewareRegistration
	215, // 156: lnrpc.RPCMiddlewareResponse.feedback:type_name -> lnrpc.InterceptFeedback
	...
	221, // 161: lnrpc.PendingChannelsResponse.PendingOpenChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	221, // 162: lnrpc.PendingChannelsResponse.WaitingCloseChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	224, // 163: lnrpc.PendingChannelsResponse.WaitingCloseChannel.commitments:type_name -> lnrpc.PendingChannelsResponse.Commitments
	221, // 164: lnrpc.PendingChannelsResponse.ClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	221, // 165: lnrpc.PendingChannelsResponse.ForceClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	...
	208, // 237: lnrpc.Lightning.CheckMacaroonPermissions:input_type -> lnrpc.CheckMacPermRequest
	213, // 238: lnrpc.Lightning.RegisterRPCMiddleware:input_type -> lnrpc.RPCMiddlewareResponse
	...
	202, // 243: lnrpc.Lightning.IsOurAddress:input_type -> lnrpc.IsOurAddressRequest
	29,  // 244: lnrpc.Lightning.GetTransaction:input_type -> lnrpc.GetTransactionRequest
	...
	209, // 306: lnrpc.Lightning.CheckMacaroonPermissions:output_type -> lnrpc.CheckMacPermResponse
	210, // 307: lnrpc.Lightning.RegisterRPCMiddleware:output_type -> lnrpc.RPCMiddlewareRequest
	...
	203, // 312: lnrpc.Lightning.IsOurAddress:output_type -> lnrpc.IsOurAddressResponse
	30,  // 313: lnrpc.Lightning.GetTransaction:output_type -> lnrpc.GetTransactionResponse
	245, // [245:314] is the sub-list for method output_type
	176, // [176:245] is the sub-list for method input_type
