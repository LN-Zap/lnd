...
func RegisterLightningJSONCallbacks(registry map[string]func(ctx context.Context,
	...
	registry["lnrpc.Lightning.IsOurAddress"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {

		req := &IsOurAddressRequest{}
		err := marshaler.Unmarshal([]byte(reqJSON), req)
		if err != nil {
			callback("", err)
			return
		...
		client := NewLightningClient(conn)
		resp, err := client.IsOurAddress(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["lnrpc.Lightning.GetTransaction"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {
