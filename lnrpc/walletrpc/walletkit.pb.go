...
var file_walletrpc_walletkit_proto_rawDesc = []byte{
	...
	0x55, 0x74, 0x78, 0x6f, 0x73, 0x22, 0x53, 0x0a, 0x1d, 0x53, 0x69, 0x67, 0x6e, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x46, 0x72, 0x6f, 0x6d, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73,
	0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73,
	0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x3e, 0x0a, 0x1e, 0x53, 0x69,
	0x67, 0x6e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x46, 0x72, 0x6f, 0x6d, 0x41, 0x64, 0x64,
	...
	0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x2a, 0x7a, 0x0a, 0x0b, 0x41, 0x64,
	...
	0x48, 0x41, 0x53, 0x48, 0x10, 0x03, 0x2a, 0x99, 0x03, 0x0a, 0x0b, 0x57, 0x69, 0x74, 0x6e, 0x65,
	...
	0x10, 0x0d, 0x32, 0xe6, 0x0c, 0x0a, 0x09, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x4b, 0x69, 0x74,
	...
	0x6c, 0x6c, 0x65, 0x74, 0x72, 0x70, 0x63, 0x2e, 0x46, 0x69, 0x6e, 0x61, 0x6c, 0x69, 0x7a, 0x65,
	0x50, 0x73, 0x62, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x6d, 0x0a, 0x16,
	0x53, 0x69, 0x67, 0x6e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x46, 0x72, 0x6f, 0x6d, 0x41,
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x28, 0x2e, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x72,
	0x70, 0x63, 0x2e, 0x53, 0x69, 0x67, 0x6e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x46, 0x72,
	0x6f, 0x6d, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x29, 0x2e, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x72, 0x70, 0x63, 0x2e, 0x53, 0x69, 0x67,
...
var file_walletrpc_walletkit_proto_msgTypes = make([]protoimpl.MessageInfo, 45)
var file_walletrpc_walletkit_proto_goTypes = []interface{}{
	...
	(*SignMessageFromAddressRequest)(nil),     // 43: walletrpc.SignMessageFromAddressRequest
	(*SignMessageFromAddressResponse)(nil),    // 44: walletrpc.SignMessageFromAddressResponse
	(*ListSweepsResponse_TransactionIDs)(nil), // 45: walletrpc.ListSweepsResponse.TransactionIDs
	nil,                              // 46: walletrpc.TxTemplate.OutputsEntry
	(*lnrpc.Utxo)(nil),               // 47: lnrpc.Utxo
	(*lnrpc.OutPoint)(nil),           // 48: lnrpc.OutPoint
	(*signrpc.TxOut)(nil),            // 49: signrpc.TxOut
	(*lnrpc.TransactionDetails)(nil), // 50: lnrpc.TransactionDetails
	(*signrpc.KeyLocator)(nil),       // 51: signrpc.KeyLocator
	(*signrpc.KeyDescriptor)(nil),    // 52: signrpc.KeyDescriptor
}
var file_walletrpc_walletkit_proto_depIdxs = []int32{
	47, // 0: walletrpc.ListUnspentResponse.utxos:type_name -> lnrpc.Utxo
	48, // 1: walletrpc.LeaseOutputRequest.outpoint:type_name -> lnrpc.OutPoint
	48, // 2: walletrpc.ReleaseOutputRequest.outpoint:type_name -> lnrpc.OutPoint
	...
	49, // 10: walletrpc.SendOutputsRequest.outputs:type_name -> signrpc.TxOut
	48, // 11: walletrpc.PendingSweep.outpoint:type_name -> lnrpc.OutPoint
	...
	48, // 14: walletrpc.BumpFeeRequest.outpoint:type_name -> lnrpc.OutPoint
	50, // 15: walletrpc.ListSweepsResponse.transaction_details:type_name -> lnrpc.TransactionDetails
	45, // 16: walletrpc.ListSweepsResponse.transaction_ids:type_name -> walletrpc.ListSweepsResponse.TransactionIDs
	...
	48, // 19: walletrpc.TxTemplate.inputs:type_name -> lnrpc.OutPoint
	46, // 20: walletrpc.TxTemplate.outputs:type_name -> walletrpc.TxTemplate.OutputsEntry
	48, // 21: walletrpc.UtxoLease.outpoint:type_name -> lnrpc.OutPoint
	...
	51, // 28: walletrpc.WalletKit.DeriveKey:input_type -> signrpc.KeyLocator
	...
	43, // 43: walletrpc.WalletKit.SignMessageFromAddress:input_type -> walletrpc.SignMessageFromAddressRequest
	3,  // 44: walletrpc.WalletKit.ListUnspent:output_type -> walletrpc.ListUnspentResponse
	5,  // 45: walletrpc.WalletKit.LeaseOutput:output_type -> walletrpc.LeaseOutputResponse
	7,  // 46: walletrpc.WalletKit.ReleaseOutput:output_type -> walletrpc.ReleaseOutputResponse
	42, // 47: walletrpc.WalletKit.ListLeases:output_type -> walletrpc.ListLeasesResponse
	52, // 48: walletrpc.WalletKit.DeriveNextKey:output_type -> signrpc.KeyDescriptor
	52, // 49: walletrpc.WalletKit.DeriveKey:output_type -> signrpc.KeyDescriptor
	10, // 50: walletrpc.WalletKit.NextAddr:output_type -> walletrpc.AddrResponse
	13, // 51: walletrpc.WalletKit.ListAccounts:output_type -> walletrpc.ListAccountsResponse
	15, // 52: walletrpc.WalletKit.ImportAccount:output_type -> walletrpc.ImportAccountResponse
	17, // 53: walletrpc.WalletKit.ImportPublicKey:output_type -> walletrpc.ImportPublicKeyResponse
	19, // 54: walletrpc.WalletKit.PublishTransaction:output_type -> walletrpc.PublishResponse
	21, // 55: walletrpc.WalletKit.SendOutputs:output_type -> walletrpc.SendOutputsResponse
	23, // 56: walletrpc.WalletKit.EstimateFee:output_type -> walletrpc.EstimateFeeResponse
	26, // 57: walletrpc.WalletKit.PendingSweeps:output_type -> walletrpc.PendingSweepsResponse
	28, // 58: walletrpc.WalletKit.BumpFee:output_type -> walletrpc.BumpFeeResponse
	30, // 59: walletrpc.WalletKit.ListSweeps:output_type -> walletrpc.ListSweepsResponse
	32, // 60: walletrpc.WalletKit.LabelTransaction:output_type -> walletrpc.LabelTransactionResponse
	34, // 61: walletrpc.WalletKit.FundPsbt:output_type -> walletrpc.FundPsbtResponse
	38, // 62: walletrpc.WalletKit.SignPsbt:output_type -> walletrpc.SignPsbtResponse
	40, // 63: walletrpc.WalletKit.FinalizePsbt:output_type -> walletrpc.FinalizePsbtResponse
	44, // 64: walletrpc.WalletKit.SignMessageFromAddress:output_type -> walletrpc.SignMessageFromAddressResponse
