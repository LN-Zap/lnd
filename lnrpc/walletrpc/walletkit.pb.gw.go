...
var (
	...
	pattern_WalletKit_SignMessageFromAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v2", "wallet", "signmessagefromaddress"}, "", runtime.AssumeColonVerbOpt(true)))
)
